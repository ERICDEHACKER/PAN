...
#AUTHOR : CHIGOZIEWORLDWIDE (PAN)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO PAN
...
header = {"user-agent": '[Mozilla/5.0 (Linux; U; Android 4.4.4; pt-BR; XT1068 Build/KXB21.85-23) AppleWebKit/534.30 (KHTML, like Gecko) Version/4.0;]',
